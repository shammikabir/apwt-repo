...
@section('content')
    ...
    <div class="container">
        <h4>Create Topics </h4>
        <form action=" {{ route('teacher.topics') }} " method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="topics_name" class="form-control" id="">
            </div>
            <span class="text-danger">@error('topics_name') {{$message}} @enderror</span>
